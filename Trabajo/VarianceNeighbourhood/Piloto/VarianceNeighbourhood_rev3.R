...
matrizFSueve = matrizExpGenetica(curv,3)  
...
plot(genes,devSTD2[,1], pch="*", col="black", xlab="Genes", ylab="", ylim = c(0,40), xlim = c(0,100))
...
legend(1,40,legend=c("Varianza vecinos","std"), col=c("black","red"),
       pch=c("o","*"),lty=c(1,2), ncol=1)
text(50, 40, labels = "std = 3, kc=3")
