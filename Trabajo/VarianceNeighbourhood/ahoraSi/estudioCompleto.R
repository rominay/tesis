...
setwd("C:\\Users\\Elizabeth\\Desktop\\Tesis-Redes\\Practica-R\\PracticaRTesis\\VarianceNeighbourhood\\ahoraSi\\EstudioOrdenTemporal\\std1-vol2")
...
#text(100, 265, labels = "genesString genes, std = 3, shuffle 100%",font=2, cex=1.5)
#text(0.5, 1.1 , ("std = 2, 500 genes, 5 grupos funcionales"),font=2, cex=1.5)
legend(0.1,60,legend=c("Sin filtrar","Filtrado"), col=c("black","red"),pch=c("*","o"), cex=1.5,box.lty = 2)
Corner_text(text="std = 1, 500 genes, 5 grupos funcionales",location= "topright")
